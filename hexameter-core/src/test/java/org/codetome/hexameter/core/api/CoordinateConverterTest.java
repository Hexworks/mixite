...
public class CoordinateConverterTest {
	...
	public void shouldConvertOffsetCoordinatesToAxialXWithPointy() {
		final int result = CoordinateConverter.convertOffsetCoordinatesToAxialX(TEST_X, TEST_Y, HexagonOrientation.POINTY_TOP);
		assertEquals(EXPECTED_AXIAL_X_WITH_POINTY, result);
	}

	@Test
	public void shouldConvertOffsetCoordinatesToAxialXWithFlat() {
		final int result = CoordinateConverter.convertOffsetCoordinatesToAxialX(TEST_X, TEST_Y, HexagonOrientation.FLAT_TOP);
		assertEquals(EXPECTED_AXIAL_X_WITH_FLAT, result);
	}

	@Test
	public void shouldConvertOffsetCoordinatesToAxialZWithPointy() {
		final int result = CoordinateConverter.convertOffsetCoordinatesToAxialZ(TEST_X, TEST_Y, HexagonOrientation.POINTY_TOP);
		assertEquals(EXPECTED_AXIAL_Z_WITH_POINTY, result);
	}

	@Test
	public void shouldConvertOffsetCoordinatesToAxialZWithFlat() {
		final int result = CoordinateConverter.convertOffsetCoordinatesToAxialZ(TEST_X, TEST_Y, HexagonOrientation.FLAT_TOP);
