...
class CoordinateConverterTest {
    ...
    fun shouldThrowExceptionWhenInstantiated() {
        assertFailsWith<UnsupportedOperationException> {
            org.hexworks.mixite2.core.api.CoordinateConverter()
        }
    }

    @Test
    fun shouldConvertOffsetCoordinatesToAxialXWithPointy() {
        val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertOffsetCoordinatesToCubeX(TEST_X, TEST_Y, HexagonOrientation.POINTY_TOP)
        assertEquals(EXPECTED_AXIAL_X_WITH_POINTY, result)
    }

    @Test
    fun shouldConvertOffsetCoordinatesToAxialXWithFlat() {
        val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertOffsetCoordinatesToCubeX(TEST_X, TEST_Y, HexagonOrientation.FLAT_TOP)
        assertEquals(EXPECTED_AXIAL_X_WITH_FLAT, result)
    }

    @Test
    fun shouldConvertOffsetCoordinatesToAxialZWithPointy() {
        val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertOffsetCoordinatesToCubeZ(TEST_X, TEST_Y, HexagonOrientation.POINTY_TOP)
        assertEquals(EXPECTED_AXIAL_Z_WITH_POINTY, result)
    }

    @Test
    fun shouldConvertOffsetCoordinatesToAxialZWithFlat() {
        val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertOffsetCoordinatesToCubeZ(TEST_X, TEST_Y, HexagonOrientation.FLAT_TOP)
    ...
    fun shouldConvertCubeCoordinatesToOffsetRowWithFlat() {
        for((i, cube) in testCubes.withIndex()) {
            val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertCubeCoordinateToOffsetRow(cube, HexagonOrientation.FLAT_TOP)
    ...
    fun shouldConvertCubeCoordinatesToOffsetColWithFlat() {
        for((i, cube) in testCubes.withIndex()) {
            val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertCubeCoordinateToOffsetColumn(cube, HexagonOrientation.FLAT_TOP)
    ...
    fun shouldConvertCubeCoordinatesToOffsetRowWithPointy() {
        for((i, cube) in testCubes.withIndex()) {
            val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertCubeCoordinateToOffsetRow(cube, HexagonOrientation.POINTY_TOP)
    ...
    fun shouldConvertCubeCoordinatesToOffsetColWithPointy() {
        for((i, cube) in testCubes.withIndex()) {
            val result = org.hexworks.mixite2.core.api.CoordinateConverter.convertCubeCoordinateToOffsetColumn(cube, HexagonOrientation.POINTY_TOP)
    ...
    companion object {
        ...
        private val testCubes = arrayOf(
            org.hexworks.mixite2.core.api.CubeCoordinate.fromCoordinates(-1, -2),
            org.hexworks.mixite2.core.api.CubeCoordinate.fromCoordinates( 2, -3),
            org.hexworks.mixite2.core.api.CubeCoordinate.fromCoordinates( 7,  8)
        )
