...
interface HexagonalGrid<T : SatelliteData> {
     ...
     */
    fun getHexagonsByCubeRange(from: org.hexworks.mixite2.core.api.CubeCoordinate, to: org.hexworks.mixite2.core.api.CubeCoordinate): Iterable<Hexagon<T>>
     ...
     */
    fun containsCubeCoordinate(coordinate: org.hexworks.mixite2.core.api.CubeCoordinate): Boolean
     ...
     */
    fun getByCubeCoordinate(coordinate: org.hexworks.mixite2.core.api.CubeCoordinate): Maybe<Hexagon<T>>
     ...
     */
    fun getNeighborCoordinateByIndex(coordinate: org.hexworks.mixite2.core.api.CubeCoordinate, index: Int): org.hexworks.mixite2.core.api.CubeCoordinate
