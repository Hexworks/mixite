...
public interface HexagonalGrid<T extends SatelliteData> {
     ...
     * @return hexagons
     */
    Iterable<Hexagon<T>> getHexagons();
     ...
     */
    Iterable<Hexagon<T>> getHexagonsByCubeRange(CubeCoordinate from, CubeCoordinate to);
     ...
     * @return {@link Hexagon}s in the given range.
     */
    Iterable<Hexagon<T>> getHexagonsByOffsetRange(int gridXFrom, int gridXTo, int gridYFrom, int gridYTo);
